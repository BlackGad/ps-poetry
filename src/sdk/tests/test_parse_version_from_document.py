...
from ps.plugin.sdk.helpers.toml import parse_version_from_document
...
"""
    ...
    location = parse_version_from_document(document)
    assert location.value == "1.2.3"
